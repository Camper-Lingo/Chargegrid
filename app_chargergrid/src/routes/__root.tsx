  ...
  head: () => ({
    meta: [
      ...
      { title: "ChargeGrid — Recarga inteligente de veículos elétricos" },
      {
        name: "description",
        content:
          "Escolha quanto quer carregar, veja os kWh necessários e o preço antes de iniciar. Recarga inteligente com tarifa por horário.",
      },
      { name: "author", content: "ChargeGrid" },
      { property: "og:title", content: "ChargeGrid — Recarga inteligente de veículos elétricos" },
      {
        property: "og:description",
        content:
          "Escolha quanto quer carregar e saiba quanto vai pagar antes mesmo de iniciar a recarga.",
      },
